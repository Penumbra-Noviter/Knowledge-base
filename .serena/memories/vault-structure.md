...
- 来源记录由 frontmatter `source:` 字段承担（原 `来源/` 目录 2026-08-08 删除；仅当需整页保留原文摘录时重建）
- `附件/` — 图片等
...
- **索引机制**：经验条目 <60 时 Home.md 手工 MOC（注册表 + Home 双处同步）；≥60 时上 Dataview 按 project 自动分组，Home 只留静态导航
